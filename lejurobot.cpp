...
constexpr size_t SPEED_DEFAULT = 15;
...
int main()
{
  ...
  WalkPatternGen<double> walk3({ 0,0,param::COM_Z - LEJU_COM_Z_FALL_DOWN<double>-0.07 });
  ...
  WalkPatternGen<double> walk4({ 0,0,param::COM_Z - LEJU_COM_Z_FALL_DOWN<double>-0.07 });
